...
function addBox() {
  ...
  content += '<button id="' + boxName.value + 'Button" class="btn waves-effect grey-text text-darken-4" ';
  content += 'onclick="takeAll(' + "'" + boxName.value + "Button'" + ')">';
  content += 'Tomar todos</button>';
